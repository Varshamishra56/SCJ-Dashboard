      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mt-24">
          <div className="text-center mb-16 mt-8">
            ...
            <p className="text-gray-300 text-base md:text-lg max-w-3xl mx-auto">
              Track your content performance metrics and revenue across
              different platforms
            </p>
          </div>
              ...
              {[
                ...
                >
                      ...
                      <div className="relative h-full flex items-end">
                        {stat.sparkline.map((value, i) => (
                          <div
                            ...
                            style={{
                              height: `${
                                (value / Math.max(...stat.sparkline)) * 100
                              }%`,
                            }}
                          ></div>
                        ))}
                  ...
                  <div className="flex items-center">
                    <span
                      className={`inline-flex items-center px-2 py-0.5 rounded text-sm bg-green-500/20 text-green-400`}
                    >
                      <svg
              ...
              <div className="space-y-6 sm:space-y-8 max-w-xl mx-auto lg:max-w-none">
                ...
                <div className="relative rounded-xl overflow-hidden shadow-2xl group">
                  ...
                  <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6">
                    ...
                    <p className="text-gray-200 text-xs sm:text-sm">
                      We partner with leading platforms to maximize your
                      content's reach and revenue potential
                    </p>
                  </div>
                </div>
                ...
                <div className="relative rounded-xl overflow-hidden shadow-2xl group">
                  ...
                  <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6">
                    ...
                    <p className="text-gray-200 text-xs sm:text-sm">
                      Your content, available to audiences worldwide through our
                    ...
                    {[
                      {
                        ...
                        desc: "Fill out the form with your content information",
                      },
                      {
                        step: 2,
                        title: "Review Process",
                        desc: "Our team evaluates your content within 5 business days",
                      },
                      {
                        step: 3,
                        title: "Distribution Strategy",
                        desc: "We develop a customized distribution plan",
                      },
                    ].map((item) => (
                      <div
                        key={item.step}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      ...
                      },
                      {
                        ...
                        desc: "Quick review and distribution process",
                      },
                      {
                        icon: "🛡️",
                      ...
                      >
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            <h4 className="text-white text-sm sm:text-base font-medium mb-1">
                              {benefit.title}
                            </h4>
                            <p className="text-gray-400 text-xs sm:text-sm">
                              {benefit.desc}
                          ...
                          >
                            ...
                            <div className="w-full h-[50px] sm:h-[60px] flex items-center bg-white/5 border-2 border-white/10 rounded-xl peer-checked:border-yellow-400 peer-checked:bg-yellow-400/10 hover:bg-white/10 transition-all duration-300">
                              <div className="flex items-center px-3 sm:px-5">
                                <span className="text-white text-base sm:text-lg peer-checked:text-yellow-400">
                                  {format}
                                </span>
                              </div>
                            </div>
                          ...
                          onBlur={(e) => {
                            if (!e.target.value) {
                              e.target.style.height =
                                e.target.offsetWidth <= 640 ? "50px" : "60px";
                            }
                          }}
                        ></textarea>
                      </div>
                    ...
                    <div className="flex items-start space-x-3 group">
                      <label className="relative flex items-center cursor-pointer pt-1">
                        ...
                        <div className="w-5 sm:w-6 h-5 sm:h-6 border-2 rounded-md border-white/30 peer-checked:border-yellow-400 peer-checked:bg-yellow-400 flex items-center justify-center transition-all duration-300">
                          <svg
                            className="w-3 sm:w-4 h-3 sm:h-4 text-black hidden peer-checked:block"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
